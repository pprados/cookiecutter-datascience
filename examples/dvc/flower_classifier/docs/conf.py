...
s3_bucket = "flower_classifier".replace('_','-')
# For git clone ...
git_url = _git_url()
# Project home
...
htmlhelp_basename = 'flower_classifierdoc'
...
latex_documents = [
    (
        master_doc,  # Doc name
        'flowerclassifier.tex',  # targetname
        'BDA Project Documentation',  # title
        'flowerclassifier',  # author
