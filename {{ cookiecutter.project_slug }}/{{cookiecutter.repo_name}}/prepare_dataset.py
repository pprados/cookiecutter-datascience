...
def main(input_raw_filepath, output_interim_filepath):
    ...
    pathlib.Path(os.path.dirname(output_interim_filepath)).mkdir(parents=True, exist_ok=True)
    copyfile(input_raw_filepath, output_interim_filepath)  # FIXME: remove this sample line
